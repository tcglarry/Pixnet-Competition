...
def inpainting(quiz, debug=True):
    ...
    --model  saved_models/mosaic.pth --output-image {submit_folder}/gen_image{question_id}_2.jpg  --cuda 0", shell=True)
...
def submit_image(question_id):
    ...
    image = ski_io.imread(f'submit_images/gen_image{question_id}.jpg')
